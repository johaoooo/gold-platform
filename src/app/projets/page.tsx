      ...
      <main className="min-h-screen bg-bg pt-32">
        <div className="flex items-center justify-center py-20">
          <div className="flex items-center gap-3 text-text-2">
            <Loader2 size={20} className="animate-spin text-vert-accueil" />
    ...
    <main className="min-h-screen bg-bg pt-32 pb-20">
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          {!isLoggedIn && (
            <div className="mt-6 inline-flex items-center gap-3 bg-vert-accueil/10 border border-vert-accueil/20 rounded-full px-5 py-2.5">
              <span className="text-vert-accueil/80 text-xs">Connectez-vous pour investir dans ces projets</span>
              <Link href="/connexion" className="text-xs font-bold text-vert-accueil hover:underline flex items-center gap-1">
              ...
              <button
                ...
                className={`px-5 py-2.5 rounded-full font-syne text-sm transition-all duration-300 flex items-center gap-2 ${
                  secteurActif === s.value
                    ? 'bg-vert-accueil text-white font-semibold shadow-lg scale-105'
                    : 'bg-surface text-text-2 hover:bg-vert-accueil/10 hover:text-vert-accueil border border-white/5 hover:border-vert-accueil/30'
                }`}
              >
                <Icon size={14} />
                {s.label}
        ...
        <div className="text-center mt-16">
          <button
            ...
            className="inline-flex items-center gap-3 px-8 py-4 rounded-full font-syne font-bold text-sm uppercase tracking-wider text-white transition-all duration-300 hover:scale-105 bg-vert-accueil hover:bg-green-600"
          >
            <Plus size={18} />
            Proposer mon projet
          </button>
