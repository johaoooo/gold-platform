            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="flex items-center gap-2 text-[12px] font-syne uppercase tracking-[0.2em] text-white/60 hover:text-red-400 transition-all px-4 py-2 rounded-full border border-transparent hover:border-red-500/30 hover:bg-red-500/10"
                >
                  <LogOut size={14} />
                  Déconnexion
                </button>
              ...
              <>
                ...
                <Link
                  href="/inscription"
                  className="px-6 py-2.5 text-[11px] font-syne font-bold uppercase tracking-wider rounded-full bg-gold text-bg hover:bg-gold-light transition-all"
                >
                  Commencer
                </Link>
              </>
          ...
          {user ? (
            <>
              ...
              >
                ...
                <span className="text-sm font-dm text-white">{user.username}</span>
                <span className="text-[10px] font-syne text-gold uppercase">
                  {user.role === 'investisseur' ? 'Invest' : 'Porteur'}
                </span>
              </Link>
